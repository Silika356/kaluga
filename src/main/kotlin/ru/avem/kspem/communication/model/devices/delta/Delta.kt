...
class Delta(
    ...
    fun setObjectParamsRun(fOut: Number) {
        try {
            ...
            writeRegister(getRegisterById(MAX_FREQUENCY_REGISTER), (60.hz() + 0).toShort())
            writeRegister(getRegisterById(NOM_FREQUENCY_REGISTER), (60.hz() + 0).toShort())
            ...
            writeRegister(getRegisterById(POINT_2_VOLTAGE_REGISTER), 10.v())
            writeRegister(getRegisterById(POINT_2_FREQUENCY_REGISTER), 1.hz())
