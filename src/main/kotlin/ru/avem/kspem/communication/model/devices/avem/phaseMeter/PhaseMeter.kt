...
class PhaseMeter(
    ...
    private val model = PhaseMeterModel()
    ...
    fun startMeasure() {
        writeRegister(getRegisterById(PhaseMeterModel.uiStartStop), (1).toShort())
    }

    fun setTime(time: Int) {
        writeRegister(getRegisterById(PhaseMeterModel.measureTime), time.toShort())
    }
